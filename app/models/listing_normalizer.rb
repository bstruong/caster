  ...
  def normalize
    {
      ...
      street_address:    field("Street Address"),
      city:              field("Postal City"),
      state:             field("State"),
      zip_code:          field("Zip Code"),
      mls_area_id:       field("Area #"),
      mls_area_name:     field("Area Name"),
      property_type:     field("Property Type"),
      property_sub_type: field("Property Sub Type"),
      bedrooms:          integer(field("Beds Total")),
      ...
      listed_at:         date(field("Listing Date")),
